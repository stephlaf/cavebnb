...
caves_to_create << Cave.new(name: "GrugHub", user: User.second, description: "There's so much grug here. Push to commit while the grugging is good.", price: "5", remote_photo_url: 'http://999thepoint.com/files/2014/03/RS5198_160550855-scr-300x199.jpg?w=980&q=75', address: "267 Rue Saint Zotique O, Montreal", rating: "4", accommodates: (rand(9)+1), number_of_beds: rand(3), bed_type: BedType.all.sample, cave_type: CaveType.all.sample)
